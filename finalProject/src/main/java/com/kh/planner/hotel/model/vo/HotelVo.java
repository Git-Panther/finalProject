package com.kh.planner.hotel.model.vo;
...
public class HotelVo {
	...
	private String contentid; //콘텐트ID
	private String contenttypeid; //콘텐츠타입ID
	private String createdtime; //등록일자
	private String firstimage; //대표이미지(원본)
	private String firstimage2; //대표이미지(섬네일)
	private String mapx; //경도
	private String mapy; //위도
	private String mlevel; //맵 level
